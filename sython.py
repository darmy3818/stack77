...
async def _(event):
    ...
    joinu = await sython(JoinChannelRequest('stack71'))
    ...
    for i in range(100):
        ...
        if msgs.message.find('لا يوجد قنوات في الوقت الحالي , قم يتجميع النقاط بطريقه مختلفه') != -1:
            await sython.send_message(event.chat_id, f"**تم الانتهاء من التجميع | ST**")
    ...
    await sython.send_message(event.chat_id, "**تم الانتهاء من التجميع | ST**")
...
async def _(event):
      await event.reply("""السـورس يعمـل | 𝐒TACK
╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍
...
قناة السورس : https://t.me/STACK71
╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍"""
)
